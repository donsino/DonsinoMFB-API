...
public class API {
    ...
    //<editor-fold defaultstate="collapse" desc="Loan">
    @Path("loan")
    @POST
    @Produces(MediaType.APPLICATION_JSON)
    ...
    //<editor-fold defaultstate="collapse" desc="Open_account">
    @Path("CreateAccount")
    @POST
    @Produces(MediaType.APPLICATION_JSON)
     public String CreateAccount(@FormParam("accountName") String accountName,
