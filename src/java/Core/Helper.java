...
public class Helper {
    ...
    String createAccount(String phone, String name,String password) {
        String accountNumber = genAN();
        try(Connection conn = getDBConnection()){
            String query = "INSERT INTO customer(accountNumber,phone,name,password) "
                    + "VALUES(?,?,?,?)";
            PreparedStatement stmt = conn.prepareStatement(query);
        ...
        public boolean Loan(String accountNumber, String loanAmount, String income,
                  String duration, String purpose){
        try(Connection conn = getDBConnection()){
